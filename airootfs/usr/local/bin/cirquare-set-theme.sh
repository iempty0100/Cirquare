...
# --- 배경화면 적용 ---
# 모니터 이름은 하드웨어마다 다르므로(VM: Virtual-1, 실기기: eDP-1/HDMI-1 등)
# xrandr로 실제 연결된 출력 이름을 런타임에 감지해서 xfconf 키를 만든다.
...
# --- Papirus 폴더 색상을 회색으로 (무채색 통일감) ---
if command -v papirus-folders >/dev/null 2>&1; then
    papirus-folders -C grey --theme "$ICON_THEME" >/dev/null 2>&1
fi
